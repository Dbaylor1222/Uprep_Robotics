###########################################################################
## Makefile generated for component 'Drive1'. 
## 
## Makefile     : Drive1.mk
## Generated on : Tue Apr 27 11:44:32 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Drive1.elf
...
COMPILER_COMMAND_FILE     = Drive1_comp.rsp
CMD_FILE                  = Drive1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Drive1.elf
...
DEFINES_STANDARD = -DMODEL=Drive1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Drive1.o Drive1_data.o rt_zcfcn.o MW_Vex_TaskControl.o MW_SupportFunc_Wrapper.o MW_TabManager.o MW_FreeRTOS_glue.o FreeRTOS_asm_vectors.o croutine.o event_groups.o list.o queue.o tasks.o timers.o heap_4.o port.o portASM.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
%.o : $(START_DIR)/Drive1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Drive1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Drive1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Drive1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Drive1_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Drive1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Drive1.o : $(START_DIR)/Drive1_ert_rtw/Drive1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Drive1_data.o : $(START_DIR)/Drive1_ert_rtw/Drive1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.o : $(START_DIR)/Drive1_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
